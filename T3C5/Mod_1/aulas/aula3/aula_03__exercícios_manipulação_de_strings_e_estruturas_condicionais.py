# -*- coding: utf-8 -*-
"""Aula_03_- Exercícios - Manipulação_de_Strings_e_Estruturas_Condicionais.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1WoJTRYDGVyGhPtqkiIfUGCm-domTg8xs
...
n1 = float(input('Qual foi a nota do primeiro semestre ?').replace("," , "."))
n2 = float(input('Qual foi a nota do segundo semestre ?').replace("," , "."))
media = (n1+n2) / 2
if media >= 6 :
    print("Parabéns, você foi aprovado!")

else:
    print("Ops, infelizmente você foi reprovado.")
...
Agora implemente a funcionalidade de não aceitar o número 0.
"""
...
if number < 0 :
  ...
  print("Tente novamente, digitando um número que não seja zero.")
...
print('Digite a primeira letra do seu sexo')
...
note = float(input('Informe a nota entre 0 e 10\n').replace(',' , '.'))
...
vocation = str(input('Você quer ser medieval ou futurista ?\n').upper())
if vocation == 'MEDIEVAL':
  print(f'Sua arma será uma espada')
elif vocation == 'FUTURISTA':
  print(f'Sua arma será um sabre de luz')
...
print('Ataque o Chefão')
attack = str(input('Qual arma você utiliza ?'))
if attack == 'ESPADA':
  print('Você ainda não derrotou o chefão')
elif attack == 'Sabre de luz':
